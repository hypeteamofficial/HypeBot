...
const sub = "dogpictures"

module.exports = {
  catagory: 'reddit',
  name: 'dogpic',
  desc: 'Get a random post from r/dogpictures',
  aliases: ['dog', 'doggo', 'woof'],
...
request({
    ...
    embed.setThumbnail('https://styles.redditmedia.com/t5_2qhhk/styles/communityIcon_n7ckf4gv4ik11.png')
