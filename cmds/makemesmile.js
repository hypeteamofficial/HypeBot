...
const sub = "MadeMeSmile"

module.exports = {
  catagory: 'reddit',
  name: 'makemesmile',
  desc: 'Get a random post from r/MadeMeSmile.',
  aliases: ['MadeMeSmile'],
...
request({
    ...
    embed.setThumbnail('https://styles.redditmedia.com/t5_2uqcm/styles/communityIcon_kfqpkjbvpv001.png?')
